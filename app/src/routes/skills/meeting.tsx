...
export default function MeetingSkillRoute() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      pushToast("success", "Meeting skill configured.");
      navigate("/dashboard");
    } catch (e) {
