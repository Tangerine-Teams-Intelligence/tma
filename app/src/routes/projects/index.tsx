...
export default function ProjectsListRoute() {
  ...
  useEffect(() => {
    ...
    readProjectsList()
      ...
      .catch((e: unknown) => {
        if (cancel) return;
        setError(typeof e === "string" ? e : (e as Error)?.message ?? "Could not read projects.");
        setLoading(false);
      });
    return () => {
      cancel = true;
    ...
    <div className="bg-stone-50 dark:bg-stone-950">
      <div className="mx-auto max-w-3xl px-8 py-10">
        ...
        <section className="mt-8 overflow-hidden rounded-md border border-stone-200 dark:border-stone-800">
          {loading ? (
            <div className="space-y-2 px-4 py-4" aria-busy="true" data-testid="projects-loading">
            ...
            <div className="px-4 py-8 text-center">
              <FolderKanban size={20} className="mx-auto text-stone-400" />
              <p className="mt-3 text-[12px] text-stone-700 dark:text-stone-300">
